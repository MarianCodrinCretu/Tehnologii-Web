...
newNode.innerHTML = `
          <div class="upload_info">
            ...
            <input type="text" value="-" name="url{0}" id="url_{0}" required><br/><br/>
            
          </div>
          <div class="question_info">
            <label for="question_q_{1}"><span id='Question_q_{1}'>Question:<br/></span></label>
            <input type="text" value="-" name="intrebare{1}" id="question_q_{1}" required><br/><br/>
            <div class="response">
              <label for="scenario_{1}_1"><span id='Scenario_{1}_1'>Scenario 1:<br/></span></label>
              <input type="text" value="-" name="scenariu_{1}_1" id="scenario_{1}_1" required>
            ...
            <div class="response">
              ...
              <input type="text" value="-" name="scenariu_{1}_2" id="scenario_{1}_2" required>
            ...
            <div class="response">
              ...
              <input type="text" value="-" name="scenariu_{1}_3" id="scenario_{1}_3" required>
            ...
            <div class="response">
              ...
              <input type="text" value="-" name="scenariu_{1}_4" id="scenario_{1}_4" required>
