...
class Movie {
    ...
    */
    ...
    public function insertMovie($title, $description)

    {
        ...
        //echo 'cretu1!!';
        $stmtInsert = $this->pdo->prepare('INSERT INTO movies (title, tree_id, description) VALUES (:title, :tree_id, :description)');
        $stmtInsert->execute(['title' => $title, 'tree_id'=>$max+1, 'description' => $description]);
