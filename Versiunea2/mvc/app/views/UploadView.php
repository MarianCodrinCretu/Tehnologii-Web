    ...
    <form action="" method="POST">
      <div class="card">
        <div class="movie_info">
            ...
            <input type="text" name="titlu" id="title" required> <br/><br/>
            
            <label for="info"><span id="Movie_Info">Movie Description:<br/></span></label>
            <input type="text" name="descriere" id="info" required> <br/><br/>

            <label for="gen"><span id="Movie_Gen">Movie Genre:<br/></span></label>
            <input type="text" name="categorie" id="gen" required> <br/><br/>

            <label for="actors"><span id="Movie_Actors">Movie Actors:<br/></span></label>
            <input type="text" name="actori" id="actors" required> <br/><br/>
        ...
        <div class="movie">
          <div class="upload_info">
            ...
            <input type="text" name="url1" id="url_1" required><br/><br/>
            
          </div>
          <div class="question_info">
            <label for="question_q_1"><span id="Question_q_1">Question:<br/></span></label>
            <input type="text" name="intrebare1" id="question_q_1" required><br/><br/>
            <div class="response">
              <label for="scenario_1_1"><span id="Scenario_1_1">Scenario 1:<br/></span></label>
              <input type="text" name="scenariu_1_1" id="scenario_1_1" required>
              ...
              <input type="text" name="scenariu_1_2" id="scenario_1_2" required>
              ...
              <input type="text" name="scenariu_1_3" id="scenario_1_3" required>
              ...
              <input type="text" name="scenariu_1_4" id="scenario_1_4" required>
      ...
      <footer>
      <div>
        <button onclick="addPart()" class="btnAddParts">Add More Parts</button><br/><br/><br/>
      </div>
    </footer>
